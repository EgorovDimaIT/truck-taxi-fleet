...
class VehicleController extends Controller
{
    ...
    public function track(string $id, Request $request)
    {
        ...
        $positionData = $this->positionDataFromTrackingInput($latitude, $longitude, $altitude, $heading, $speed, $occurredAt);
    ...
    protected function positionDataFromTrackingInput(float $latitude, float $longitude, mixed $altitude = null, mixed $heading = null, mixed $speed = null, mixed $occurredAt = null): array
    {
        return [
