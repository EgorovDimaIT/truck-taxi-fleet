...
return [
    'providers' => [
        ...
        [
            ...
            'label'           => 'Traccar',
            'type'            => 'native',
            'driver_class'    => Fleetbase\FleetOps\Support\Telematics\Providers\TraccarProvider::class,
            'icon'            => '/engines-dist/images/telematics/providers/traccar.webp',
            'description'     => 'Traccar (self-hosted GPS platform) and the Traccar Client mobile app push position updates directly to Fleetbase via webhook - no polling required.',
            ...
            'required_fields' => [
                [
                    ...
                    'required'    => false,
                    'help_text'   => 'If set, incoming positions must carry this value in the X-Webhook-Signature header.',
                ],
                [
                    'name'        => 'server_url',
            ...
            'metadata'           => [
                ...
                'pagination'   => 'none',
                'mode'         => 'push',
                'capabilities' => ['tracking', 'speed', 'heading', 'altitude', 'odometer', 'fuel_level', 'ignition', 'battery'],
            ],
        ],
    ],
];
