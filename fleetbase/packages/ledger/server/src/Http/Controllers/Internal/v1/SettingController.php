...
class SettingController extends Controller
{
    ...
    public function getInvoiceSettings(): JsonResponse
    {
        $defaults = [
            ...
            'default_notes'            => "Реквізити для оплати:\nФОП Єгоров Д. В., ІПН 3049228154\nр/р UA673253650000000260030043249 у банку ПАТ «КРЕДОБАНК», код банку 0\nАдреса: 08115, Київська обл., Києво-Святошинський р-н, с. Чайки, вул. Лобановського, 10, кв. 8\nНе є платником податку на прибуток на загальних підставах (ПДВ не оподатковується).",
            'default_terms'            => "Оплата даного рахунку означає згоду з умовами поставки товару. Повідомлення про оплату є обов'язковим, в іншому випадку не гарантується наявність товару на складі. Товар відпускається за фактом надходження коштів на р/р Постачальника, самовивозом, при наявності довіреності та паспорта.",
