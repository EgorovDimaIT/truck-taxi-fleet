...
class SendResourceLifecycleWebhook implements ShouldQueue
{
     ...
     * @return string
     */
    // NOTE: type-hint intentionally relaxed to accept any event object (e.g. GeofenceEntered/GeofenceExited)
    // that duck-types these properties but does not extend ResourceLifecycleEvent - fixes TypeError seen in queue logs.
    public function getHumanReadableEventDescription($event)
    {
