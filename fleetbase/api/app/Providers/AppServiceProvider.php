...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        // Register Cloudinary filesystem driver explicitly so it works in all contexts
        if (class_exists(\CloudinaryLabs\CloudinaryLaravel\CloudinaryAdapter::class)) {
            Storage::extend('cloudinary', function ($app, $config) {
                $adapter = new \CloudinaryLabs\CloudinaryLaravel\CloudinaryAdapter(
