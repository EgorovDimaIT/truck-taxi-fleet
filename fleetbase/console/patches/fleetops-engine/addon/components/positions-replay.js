...
import { MAPBOX_TILE_URL_LIGHT } from '../utils/mapbox-tiles';
...
export default class PositionsReplayComponent extends Component {
    ...
    @tracked zoom = 14;
    // Match the rest of fleetops' Leaflet maps (Mapbox basemap), consistent with
    // Map::LeafletLiveMap and Widget::LiveFleet. Overridable via company map
    // settings below (mapSettings.leafletTileUrl), same as before.
    ...
    constructor() {
        ...
        // does not change behavior when no custom URL is saved. Mirrors the same
        // pattern used by Map::LeafletLiveMap so both maps stay in sync.
