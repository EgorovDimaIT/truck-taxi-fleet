...
import { MAPBOX_TILE_URL_LIGHT, MAPBOX_ATTRIBUTION } from '../../../../utils/mapbox-tiles';

export default class PortalOrderWorkspaceMapComponent extends Component {
    @service customerPortalOrderRoutePreview;

    tileSourceUrl = MAPBOX_TILE_URL_LIGHT;
    tileAttribution = MAPBOX_ATTRIBUTION;
    ...
    get center() {
        ...
        return {
            latitude: Number(firstMarker?.latitude) || 50.4501,
            longitude: Number(firstMarker?.longitude) || 30.5234,
        };
    }
